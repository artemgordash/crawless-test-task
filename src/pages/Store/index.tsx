...
import StatsLeftDecorations from '@/components/modules/store/StatsLeftDecorations';
import StatsRightDecorations from '@/components/modules/store/StatsRightDecorations';
